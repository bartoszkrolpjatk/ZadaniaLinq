...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie01_StudenciZWarszawy()
    {
        return DaneUczelni.Studenci
            .Where(s => s.Miasto.Equals("Wroclaw"))
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        return
        [
            DaneUczelni.Zapisy.Count(z => z.CzyAktywny).ToString()
        ];
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty,
                combined => combined.PrzedmiotId,
                p => p.Id,
                (combined, p) => $"{combined.Imie} {combined.Nazwisko} {p.Nazwa}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .Where(e => e.Zapisy.Any() && e.Zapisy.All(z => z.OcenaKoncowa == null))
            .Select(e => $"{e.Nazwa}");
    }
